...
import { ConfigHubFeatureEnablementGuard } from './feature-enablement.guard';

describe('ConfigHubFeatureEnablementGuard', () => {
	let configHubFeatureEnablementGuard: ConfigHubFeatureEnablementGuard;
	let router: Router;
	...
	beforeEach(() => {
		...
		configHubFeatureEnablementGuard = TestBed.inject(ConfigHubFeatureEnablementGuard);
	...
	describe('canActivate()', () => {
		it('should return false and redirect if user does not have the correct right', done => {
			...
			configHubFeatureEnablementGuard.canActivate().then(result => {
